...
<div id="blogs-container">
    ...
    <div class="blog fade-up">
            ...
            <div class="blog-text">
                <div class="blog-heading">HOW IT STARTED</div>
    ...
    <!-- BLOG -->
       <div class="blog fade-up">
        <div class="blog-img">
            <img src="{{Vite::asset('resources/assets/images/about-img.jpg')}}" alt="blog-img">
        </div>
        <div class="blog-text">
            <div class="blog-heading">NEW ALBUM RELEASE</div>
            <div class="blog-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo voluptas ea voluptatum itaque? Eaque vitae eveniet sequi alias laborum exercitationem veritatis, nam ut officiis a aliquam tempore atque blanditiis quaerat....</div>
            <div class="blog-info">
                <div class="blog-duration"><img src="{{Vite::asset('resources/assets/images/clock.png')}}" alt="clock">&nbsp; 3 Min </div>
    ...
    <!-- BLOG -->
       <div class="blog fade-up">
        <div class="blog-img">
            <img src="{{Vite::asset('resources/assets/images/album-thumbnail-nine.jpg')}}" alt="blog-img">
        </div>
        <div class="blog-text">
            <div class="blog-heading">DJ NIGHT</div>
            <div class="blog-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo voluptas ea voluptatum itaque? Eaque vitae eveniet sequi alias laborum exercitationem veritatis, nam ut officiis a aliquam tempore atque blanditiis quaerat....</div>
            <div class="blog-info">
                <div class="blog-duration"><img src="{{Vite::asset('resources/assets/images/clock.png')}}" alt="clock">&nbsp; 11 Min </div>
    ...
    <!-- BLOG -->
       <div class="blog fade-up">
        ...
        <div class="blog-text">
            ...
            <div class="blog-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo voluptas ea voluptatum itaque? Eaque vitae eveniet sequi alias laborum exercitationem veritatis, nam ut officiis a aliquam tempore atque blanditiis quaerat....</div>
            <div class="blog-info">
                <div class="blog-duration"><img src="{{Vite::asset('resources/assets/images/clock.png')}}" alt="clock">&nbsp; 7 Min </div>
                <div class="blog-type">Song/Music</div>
    ...
    <!-- BLOG -->
       <div class="blog fade-up">
        <div class="blog-img">
            <img src="{{Vite::asset('resources/assets/images/album-thumbnail-four.jpg')}}" alt="blog-img">
        </div>
        <div class="blog-text">
            <div class="blog-heading">A TRIP TO BELGIUM</div>
            <div class="blog-description">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo voluptas ea voluptatum itaque? Eaque vitae eveniet sequi alias laborum exercitationem veritatis, nam ut officiis a aliquam tempore atque blanditiis quaerat....</div>
            <div class="blog-info">
                <div class="blog-duration"><img src="{{Vite::asset('resources/assets/images/clock.png')}}" alt="clock">&nbsp; 5 Min </div>
                <div class="blog-type">Story/Experience</div>
